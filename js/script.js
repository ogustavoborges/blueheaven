...
form: ".formjs", //Seletor do formulario
  ...
  error: "<div id='form-error'><h2>Ops! Um erro ocorreu.</h2><br> <p>Tente de novo ou envie um e-mail para contato@blueheaven.com</p></div>", //Mensagem de erro
  success: "<div id='form-success><h2>Mensagem enviada.</h2> <p>Agradecemos seu contato e retornaremos em breve.</p></div>", //Mensagem de sucesso
});
